...
export const SmilingTomatoIcon = ({ width = "115", height = "115" }: IIconProps) => {
  return (
    <svg width={width} height={height} viewBox="0 0 115 115" fill="none" xmlns="http://www.w3.org/2000/svg">
